...
static void initClassInstances(void)
{
	...
	// 20140521修正
	// 川瀬さんのキャリブレーションでは、トルク誤差最小(param_trq)と角度誤差最小(param_eq)の二つを推定
